...
import org.mozilla.tv.firefox.webdisplay.cursor.CursorEvent.CursorMoved
import org.mozilla.tv.firefox.webdisplay.cursor.CursorEvent.ScrolledToEdge
...
class WebDisplayHintViewModel(
    ...
    private val webDisplayOpened = screenController.currentActiveScreen
